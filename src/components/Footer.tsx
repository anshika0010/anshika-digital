      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <a href="#about" className="hover:text-[#652f8e]">
                About Us
              </a>
            </li>
            <li>
              <a href="#courses" className="hover:text-[#652f8e]">
                Courses
              </a>
            </li>
            <li>
              <a href="#contact" className="hover:text-[#652f8e]">
                Contact
              </a>
            </li>
            <li>
              <a href="#" className="hover:text-[#652f8e]">
                Careers
              </a>
            </li>
          </ul>
        ...
        <div>
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              href="mailto:info@designifiy.com"
              aria-label="Email"
              className="hover:text-[#652f8e]"
            >
              <Mail size={20} />
            </a>
          </div>
