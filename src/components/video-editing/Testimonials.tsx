...
const reviews = [
  ...
  { id: 5, image: "/K.webp", alt: "Google Review 5" },
  { id: 6, image: "/J.webp", alt: "Google Review 6" },
  { id: 7, image: "/H.webp", alt: "Google Review 7" },
  { id: 8, image: "/G.webp", alt: "Google Review 8" },
];
  ...
  return (
    <section className="bg-black py-10 px-4">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl sm:text-4xl py-5 font-bold text-center text-gray-200 mb-4"></h2>
